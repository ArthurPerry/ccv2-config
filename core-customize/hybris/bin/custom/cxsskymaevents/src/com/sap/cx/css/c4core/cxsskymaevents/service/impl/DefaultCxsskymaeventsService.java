...
public class DefaultCxsskymaeventsService implements CxsskymaeventsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCxsskymaeventsService.class);
	...
	{
		return DefaultCxsskymaeventsService.class.getResourceAsStream("/cxsskymaevents/sap-hybris-platform.png");
	}
