...
public class DefaultKymafixesService implements KymafixesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKymafixesService.class);
	...
	{
		return DefaultKymafixesService.class.getResourceAsStream("/kymafixes/sap-hybris-platform.png");
	}
