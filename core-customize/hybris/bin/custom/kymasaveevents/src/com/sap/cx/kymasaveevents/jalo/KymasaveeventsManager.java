 ...
 */
package com.sap.cx.kymasaveevents.jalo;
...
import com.sap.cx.kymasaveevents.constants.KymasaveeventsConstants;
 ...
 */
public class KymasaveeventsManager extends GeneratedKymasaveeventsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KymasaveeventsManager.class.getName());
	 ...
	 */
	public static KymasaveeventsManager getInstance()
	{
		return (KymasaveeventsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(KymasaveeventsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KymasaveeventsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KymasaveeventsManager called.");
		}
	}
