...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultProductrecommendationService.class);
	...
	{
		return DefaultProductrecommendationService.class.getResourceAsStream("/productrecommendation/sap-hybris-platform.png");
	}
