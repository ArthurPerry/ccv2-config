...
import com.sap.cx.css.c4core.cxsskymaevents.service.impl.DefaultCxsskymaeventsService;
 ...
 */
@IntegrationTest
public class DefaultCxsskymaeventsServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "cxsskymaeventsPlatformLogo";

		// when
		final String logoUrl = cxsskymaeventsService.getHybrisLogoUrl(logoCode);
