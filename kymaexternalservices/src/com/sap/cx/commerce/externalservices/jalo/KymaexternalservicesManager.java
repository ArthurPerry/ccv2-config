...
import com.sap.cx.commerce.externalservices.constants.KymaexternalservicesConstants;



/**
 * This is the extension manager of the Kymaexternalservices extension.
 */
public class KymaexternalservicesManager extends GeneratedKymaexternalservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(KymaexternalservicesManager.class);
	 ...
	 */
	public static KymaexternalservicesManager getInstance()
	{
		return (KymaexternalservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(KymaexternalservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KymaexternalservicesManager() // NOPMD 
	{
		LOG.debug("constructor of KymaexternalservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of KymaexternalservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of KymaexternalservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
