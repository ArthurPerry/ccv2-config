...
import com.sap.cx.commerce.externalservices.constants.KymaexternalservicesbackofficeConstants;
 ...
 */
public class KymaexternalservicesbackofficeManager extends GeneratedKymaexternalservicesbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KymaexternalservicesbackofficeManager.class.getName());
	 ...
	 */
	public static KymaexternalservicesbackofficeManager getInstance()
	{
		return (KymaexternalservicesbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(KymaexternalservicesbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KymaexternalservicesbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KymaexternalservicesbackofficeManager called.");
		}
	}
